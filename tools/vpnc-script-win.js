...
case "connect":
    ...
    var internal_ip4_netmask = env("INTERNAL_IP4_NETMASK") || "255.255.255.0";
    if (internal_ip4_netmask == "255.255.255.255") {
    ...
    // Interface metric must be set to 1 in order to prioritize VPN routes
